...
namespace Elipgo.SmartClient.Common.Reflections.Manufactures.Drivers.Uniview.UNVNet231 //Elipgo.SmartClient.Drivers.UNVNet231
{
    public class NETUNV
    {
        ...
        public class NET_UPDATE_TIME_INFO
        {
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = NETUNV.NETDEV_IPV4_LEN_MAX)]
        public string szIPAddr;                                                              /* IP Device IP */
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = NETUNV.NETDEV_USERNAME_LEN_260)]
        public string szDevUserName;                                                         /* Device username */

        [MarshalAs(UnmanagedType.ByValArray, SizeConst = NETUNV.NETDEV_LEN_260)]
        public byte[] szDevName;    /** Device name */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = NETUNV.NETDEV_MODEL_LEN_64)]
        public string szDevModel;                                                            /* Device model */
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = NETUNV.NETDEV_SERIAL_NUMBER_LEN_64)]
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = NETUNV.NETDEV_LEN_260)]
    ...
    public struct NETDEV_CLOUD_DEV_LOGIN_INFO_S
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = NETUNV.NETDEV_LEN_64)]
    ...
    public struct NETDEV_PTZ_ALLPRESETS_S
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = NETUNV.NETDEV_MAX_PRESET_NUM)]
 ...
 */
    ...
    */
    ...
    {
        const string LIBRARY_NetDEVSDK = "Libraries\\UNVNet231\\NetDEVSDK.dll";
