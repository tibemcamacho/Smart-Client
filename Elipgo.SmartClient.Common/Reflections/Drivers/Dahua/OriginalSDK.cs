...
namespace Elipgo.SmartClient.Common.Reflections.Drivers.Dahua
{
...
#else
        const string LIBRARYNETSDK = "Libraries\\Dahua351\\dhnetsdk.dll";
        const string LIBRARYCONFIGSDK = "Libraries\\Dahua351\\dhconfigsdk.dll";
#endif
