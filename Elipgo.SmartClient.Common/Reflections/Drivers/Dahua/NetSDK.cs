...
namespace Elipgo.SmartClient.Common.Reflections.Drivers.Dahua
{
    public static class NETClient
    {
                                             ...
                                             fTimeDownLoadPosCallBack cbTimeDownLoadPos, IntPtr dwUserData)
        {
            ...
            NET_TIME startTime = NET_TIME.FromDateTime(tmStart);
            NET_TIME endTime = NET_TIME.FromDateTime(tmEnd);
            result = OriginalSDK.CLIENT_DownloadByTime(lLoginID, nChannelId, (int)nRecordFileType, ref startTime, ref endTime, sSavedFileName,
        ...
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AdaptiveDownloadByTime(lLoginID, ref pstInParam, ref pstOutParam, dwWaitTime);
            NetGetLastError(result);
            return result;
        }
        /// <summary>
