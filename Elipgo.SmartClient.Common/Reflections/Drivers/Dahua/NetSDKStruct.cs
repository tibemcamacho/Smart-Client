...
namespace Elipgo.SmartClient.Common.Reflections.Drivers.Dahua
{
    ...
    public struct NET_IN_ADAPTIVE_DOWNLOAD_BY_TIME
    {
        public uint dwSize;                // struct size
        public int nChannelID;             // channel id
        public EM_QUERY_RECORD_TYPE emRecordType;           // record type
        public string szSavedFileName;        // save file path
        public NET_TIME stStartTime;            // start time
        public NET_TIME stStopTime;             // stop time 
        public fTimeDownLoadPosCallBack cbDownLoadPos;          // Download data callback function prototype
        public IntPtr dwPosUser;              // date user
        public fDataCallBack fDownLoadDataCallBack;  // Download data callback function prototype
        public EM_REAL_DATA_TYPE emDataType;             // data type for download data callback
        public IntPtr dwDataUser;             // pos user
    }

    public struct NET_OUT_ADAPTIVE_DOWNLOAD_BY_TIME
    {
        public uint dwSize;
    }
