...
{
    //AXIS
    public class Onvifv3 : AbsOnvif
    {
        public Onvifv3(string user, string pass, string host, int http, int rtcp) : base(user, pass, host, http, rtcp)
        {
            this.ONVIF_AXIS = "/onvif/services";
        }
        ...
        protected async override Task<string> getInternalBaseUri()
        {
            try
            {
                HttpClientHandler httpClientHandler = new HttpClientHandler();
                httpClientHandler.AllowAutoRedirect = false;
                urlStr = "http://" + Host + ":" + HttpPort + ONVIF_AXIS;
        ...
        protected async override Task<string> getInternalStreamUri()
        {
            ...
            try
            {
                ...
                Uri uriAux = new Uri("http://" + host);
                string HostAux = uriAux.Host;
                Uri uriRtcp = new Uri(rtspUri);
                string HostR = uriRtcp.Host;
                string Query = uriRtcp.Query;
                string AbsolutePath = uriRtcp.AbsolutePath;
                urlStream = "rtsp://" + userOnvif + ":" + pwsOnvif + "@" + HostAux + ":" + RtcpPort + AbsolutePath + Query;
        ...
        public async override void PTZControl(PtzMovement moviento, int valor, int isstopo)
        {
            try
            {
                HttpClientHandler httpClientHandler = new HttpClientHandler();
...
" + "\n" +
        ...
        public async override void PTZControlStop(PtzMovement moviento, int valor, int isstopo)
        {
            try
            {
                HttpClientHandler httpClientHandler = new HttpClientHandler();
...
" + "\n" +
        ...
        public async override void PTZControlSZoom(PtzMovement zommType, int valor, int isstopo)
        {
            try
            {
                double zoomMax = 9;
...
" + "\n" +
        ...
        protected async override Task<string> getSnapshotUri()
        {
            try
            {
                HttpClientHandler httpClientHandler = new HttpClientHandler();
...
" + "\n" +
        ...
        public async override void downloadSnapShot(string path)
        {
            try
            {
