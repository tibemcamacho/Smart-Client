...
namespace Elipgo.SmartClient.Drivers.Dahua351.NetSDKCS
{
    public class NETClient
    {
        public static AbsNetSDK driver;
        public static void SetDriver(EnumDrivers currentDriver)
        {
            driver = DriverFactoryNetSDK.GetDriver(currentDriver);
        }
            ...
            where T : struct
        {
            ...
            if (isGetLastError)
            {
                ...
                int error = driver.CLIENT_GetLastError();
                if (0 != error)
                {
        ...
        public static bool Init(fDisConnectCallBack cbDisConnect, IntPtr dwUser, NETSDK_INIT_PARAM? stuInitParam)
        {
            ...
            try
            {
                ...
                result = driver.CLIENT_InitEx(cbDisConnect, dwUser, lpInitParam);
        ...
        public static IntPtr Login(string pchDVRIP, ushort wDVRPort, string pchUserName, string pchPassword, EM_LOGIN_SPAC_CAP_TYPE emSpecCap, IntPtr pCapParam, ref NET_DEVICEINFO_Ex deviceInfo)
        {
            ...
            int error = 0;
            result = driver.CLIENT_LoginEx2(pchDVRIP, wDVRPort, pchUserName, pchPassword, emSpecCap, pCapParam, ref deviceInfo, ref error);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_Logout(lLoginID);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            driver.CLIENT_SetAutoReconnect(cbAutoConnect, dwUser);
        }
        ...
        public static void SetNetworkParam(NET_PARAM? netParam)
        {
            ...
            driver.CLIENT_SetNetworkParam(lpNetParam);
        ...
        {
            IntPtr result = IntPtr.Zero;
            result = driver.CLIENT_StartRealPlay(lLoginID, nChannelID, hWnd, rType, cbRealData, cbDisconnect, dwUser, dwWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Zero;
            result = driver.CLIENT_RealPlayEx(lLoginID, nChannelID, hWnd, rType);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_StopRealPlayEx(lRealHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_SetRealDataCallBackEx2(lRealHandle, cbRealData, dwUser, (uint)dwFlag);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_SaveRealData(lRealHandle, pchFileName);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_StopSaveRealData(lRealHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            driver.CLIENT_SetSnapRevCallBack(OnSnapRevMessage, dwUser);
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_SnapPictureEx(lLoginID, ref par, reserved); NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_CapturePictureEx(hPlayHandle, pchPicFileName, eFormat);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_SnapPictureToFile(lLoginID, ref inParam, ref outParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Zero;
            result = driver.CLIENT_PlayBackByTimeEx2(lLoginID, nChannelID, ref pstNetIn, ref pstNetOut);
        ...
        public static bool QueryRecordFile(IntPtr lLoginID, int nChannelId, EM_QUERY_RECORD_TYPE nRecordFileType, DateTime tmStart, DateTime tmEnd, string pchCardid, ref NET_RECORDFILE_INFO[] nriFileinfo, ref int filecount, int waittime, bool bTime)
        {
            ...
            try
            {
                ...
                {
                    returnValue = driver.CLIENT_QueryRecordFile(lLoginID, nChannelId, (int)nRecordFileType, ref timeStart, ref timeEnd, pchCardid, pBoxInfo, maxlen, ref filecount, waittime, bTime);
        ...
        {
            bool result = false;
            result = driver.CLIENT_GetPlayBackOsdTime(lPlayHandle, ref lpOsdTime, ref lpStartTime, ref lpEndTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="eFormat">picture type 图片类型</param>
        /// <returns>failed return false, successful return true 失败返回false 成功返回true</returns>
        public static bool CapturePicture(IntPtr hPlayHandle, string pchPicFileName, EM_NET_CAPTURE_FORMATS eFormat, AbsNetSDK driver)
        {
            bool result = false;
            result = driver.CLIENT_CapturePictureEx(hPlayHandle, pchPicFileName, eFormat);
            NetGetLastError(result);
                                                     ...
                                                     fDataCallBack fDownLoadDataCallBack, IntPtr dwDataUser, IntPtr pReserved)
        {
            ...
            result = driver.CLIENT_DownloadByTimeEx(lLoginID, nChannelId, (int)nRecordFileType, ref startTime, ref endTime, sSavedFileName,
                                             ...
                                             fTimeDownLoadPosCallBack cbTimeDownLoadPos, IntPtr dwUserData)
        {
            ...
            NET_TIME startTime = NET_TIME.FromDateTime(tmStart);
            NET_TIME endTime = NET_TIME.FromDateTime(tmEnd);
            result = driver.CLIENT_DownloadByTime(lLoginID, nChannelId, (int)nRecordFileType, ref startTime, ref endTime, sSavedFileName,
                                                     cbTimeDownLoadPos, dwUserData);
            NetGetLastError(result);
            return result;
        }
        public static IntPtr AdaptativeDownloadByTime(IntPtr lLoginID, int nChannelId, ref NET_IN_ADAPTIVE_DOWNLOAD_BY_TIME pstInParam, ref NET_OUT_ADAPTIVE_DOWNLOAD_BY_TIME pstOutParam, uint dwWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = driver.CLIENT_AdaptiveDownloadByTime(lLoginID, ref pstInParam, ref pstOutParam, dwWaitTime);
            NetGetLastError(result);
            return result;
        }
        /// <summary>
        ...
        {
            bool result = false;
            result = driver.CLIENT_StopDownload(lFileHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_GetDownloadPos(lFileHandle, ref nTotalSize, ref nDownLoadSize);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_DHPTZControlEx2(lLoginID, nChannelID, (uint)dwPTZCommand, lParam1, lParam2, lParam3, dwStop, param4);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_OpenSound(lPlayHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_CloseSound();
            NetGetLastError(result);
            return result;
        }
        #endregion
        ...
        /// <returns>failed return false, successful return true 失败返回false 成功返回true</returns>
        public static bool PlayBackControl(IntPtr lPlayHandle, PlayBackType type, AbsNetSDK driver)
        {
            bool result = false;
            switch (type)
            {
                case PlayBackType.Play:
                    result = driver.CLIENT_PausePlayBack(lPlayHandle, false);
                    NetGetLastError(result);
                    break;
                case PlayBackType.Pause:
                    result = driver.CLIENT_PausePlayBack(lPlayHandle, true);
                    NetGetLastError(result);
                    break;
                case PlayBackType.Stop:
                    result = driver.CLIENT_StopPlayBack(lPlayHandle);
                    NetGetLastError(result);
                    break;
                case PlayBackType.Fast:
                    result = driver.CLIENT_FastPlayBack(lPlayHandle);
                    NetGetLastError(result);
                    break;
                case PlayBackType.Slow:
                    result = driver.CLIENT_SlowPlayBack(lPlayHandle);
                    NetGetLastError(result);
                    break;
                case PlayBackType.Normal:
                    result = driver.CLIENT_NormalPlayBack(lPlayHandle);
                    NetGetLastError(result);
                    break;
                default:
                    break;
        ...
        {
            bool result = false;
            result = driver.CLIENT_SetDeviceMode(lLoginID, emType, pValue);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            driver.CLIENT_SetDVRMessCallBackEx1(cbMessage, dwUser);
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_StartListenEx(lLoginID);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_StopListen(lLoginID);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Zero;
            result = driver.CLIENT_RealLoadPictureEx(lLoginID, nChannelID, dwAlarmType, bNeedPicFile, cbAnalyzerData, dwUser, reserved);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_StopLoadPic(lAnalyzerHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_QuerySystemInfo(lLoginID, (int)nSystemType, pSysInfoBuffer, maxlen, ref nSysInfolen, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_QueryDeviceLog(lLoginID, ref pQueryParam, pLogBuffer, nLogBufferLen, ref pRecLogNum, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Zero;
            result = driver.CLIENT_StartTalkEx(lLoginID, pfcb, dwUser);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_StopTalkEx(lTalkHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            //result = OriginalSDK.CLIENT_RecorStartEx(lLoginID);
            result = driver.CLIENT_RecordStartEx(lLoginID);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_RecordStopEx(lLoginID);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            int result = 0;
            result = driver.CLIENT_TalkSendData(lTalkHandle, pSendBuf, dwBufSize);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            driver.CLIENT_AudioDec(pAudioDataBuf, dwBufSize);
        }
        ...
        {
            bool result = false;
            result = driver.CLIENT_ControlDevice(lLoginID, type, param, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        public static bool QueryDevState(IntPtr lLoginID, int nType, ref object obj, Type typeName, int waittime)
        {
            ...
            try
            {
                ...
                Marshal.StructureToPtr(obj, pBuf, true);
                result = driver.CLIENT_QueryDevState(lLoginID, nType, pBuf, nBufLen, ref pRetLen, waittime);
                NetGetLastError(result);
        ...
        public static bool QueryNewSystemInfo(IntPtr lLoginID, Int32 lChannel, string strCommand, ref object obj, Type typeName, int waittime)
        {
            ...
            try
            {
                ...
                {
                    returnValue = driver.CLIENT_QueryNewSystemInfo(lLoginID, strCommand, lChannel, pInBuf,
                                                         nBufSize, ref nError, waittime);
                    NetGetLastError(returnValue);
                    if (returnValue == true)
                    {
                        returnValue = driver.CLIENT_ParseData(strCommand, pInBuf, pOutBuf, (UInt32)Marshal.SizeOf(typeName), pRetLen);
        ...
        public static bool FindRecord(IntPtr lLoginID, EM_NET_RECORD_TYPE emRecordType, object oCondition, Type tyCondition, ref IntPtr lFindID, int waittime)
        {
            ...
            try
            {
                ...
                result = driver.CLIENT_FindRecord(lLoginID, ref stuInParam, ref stuOutParam, waittime);
                NetGetLastError(result);
        ...
        public static int FindNextRecord(IntPtr lFindeHandle, int nMaxNum, ref int nRetNum, ref List<object> ls, Type tyRecord, int waittime)
        {
            ...
            try
            {
                ...
                result = driver.CLIENT_FindNextRecord(ref stuInParam, ref stuOutParam, waittime);
        ...
        {
            bool result = false;
            result = driver.CLIENT_FindRecordClose(lFindHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        public static bool QueryRecordCount(IntPtr lFindHandle, ref int nRecordCount, int waittime)
        {
            ...
            result = driver.CLIENT_QueryRecordCount(ref stuInParam, ref stuOutParam, waittime);
        ...
        public static IntPtr StartFindNumberStat(IntPtr lLoginID, ref NET_IN_FINDNUMBERSTAT pstInParam, ref NET_OUT_FINDNUMBERSTAT pstOutParam)
        {
            ...
            pRet = driver.CLIENT_StartFindNumberStat(lLoginID, ref pstInParam, ref pstOutParam);
        ...
        public static int DoFindNumberStat(IntPtr lFindHandle, ref NET_IN_DOFINDNUMBERSTAT pstInParam, ref NET_NUMBERSTAT[] pNumberStats)
        {
            ...
            try
            {
                ...
                nRet = driver.CLIENT_DoFindNumberStat(lFindHandle, ref pstInParam, ref stuOutParam);
        ...
        {
            bool bRet = false;
            bRet = driver.CLIENT_StopFindNumberStat(lFindHandle);
        ...
        {
            IntPtr pRet = IntPtr.Zero;
            pRet = driver.CLIENT_AttachVideoStatSummary(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(pRet);
            return pRet;
        }
        ...
        {
            bool bRet = false;
            bRet = driver.CLIENT_DetachVideoStatSummary(lAttachHandle);
            NetGetLastError(bRet);
            return bRet;
        }
        #endregion
        ...
        {
            IntPtr result = IntPtr.Zero;
            result = driver.CLIENT_CreateTransComChannel(lLoginID, TransComType, baudrate, databits, stopbits, parity, cbTransCom, dwUser);
            NetGetLastError(result);
            return result;
        }
        ...
        public static bool SendTransComData(IntPtr lTransComChannel, byte[] byDatas)
        {
            ...
            try
            {
                ...
                result = driver.CLIENT_SendTransComData(lTransComChannel, pBuffer, (uint)byDatas.Length);
            }
            finally
            {
                Marshal.FreeHGlobal(pBuffer);
        ...
        {
            bool result = false;
            result = driver.CLIENT_DestroyTransComChannel(lTransComChannel);
            NetGetLastError(result);
            return result;
        }
        #endregion <<Trans Com>>
        ...
        {
            bool result = driver.CLIENT_SetSecurityKey(lPlayHandle, szKey, (uint)szKey.Length);
            NetGetLastError(result);
            return result;
        }
