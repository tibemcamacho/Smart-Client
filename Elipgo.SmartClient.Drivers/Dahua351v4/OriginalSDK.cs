...
namespace Elipgo.SmartClient.Drivers.Dahua351v4.NetSDKCS
{
...
#else
        const string LIBRARYNETSDK = "Libraries\\Dahua351v4\\dhnetsdk.dll";
        const string LIBRARYCONFIGSDK = "Libraries\\Dahua351v4\\dhconfigsdk.dll";
#endif
