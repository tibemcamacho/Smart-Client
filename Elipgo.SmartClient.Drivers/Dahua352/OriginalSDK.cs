...
namespace Elipgo.SmartClient.Drivers.Dahua352.NetSDKCS
{
...
#else
        const string LIBRARYNETSDK = "Libraries\\Dahua352\\dhnetsdk.dll";
        const string LIBRARYCONFIGSDK = "Libraries\\Dahua352\\dhconfigsdk.dll";
#endif
