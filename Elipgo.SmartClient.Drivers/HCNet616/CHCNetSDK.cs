...
namespace Elipgo.SmartClient.Drivers.HCNet616
{
    ...
    {
        const string LIBRARY_HCNETSDK = "Libraries\\HCNet616\\HCNetSDK.dll";
        const string LIBRARY_GETSTREAM = "Libraries\\HCNet616\\GetStream.dll";
        const string LIBRARY_VODCLIENT = "Libraries\\HCNet616\\PdCssVodClient.dll";
        const string LIBRARY_ANALYZEDATA = "Libraries\\HCNet616\\AnalyzeData.dll";
        const string LIBRARY_RECORD = "Libraries\\HCNet616\\RecordDLL.dll";
        ...
        ******************************************************************************/
        ...
        [DllImportAttribute(LIBRARY_HCNETSDK)]
