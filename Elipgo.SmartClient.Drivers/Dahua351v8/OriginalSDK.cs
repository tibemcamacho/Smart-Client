...
namespace Elipgo.SmartClient.Drivers.Dahua351v8.NetSDKCS
{
...
#else
        const string LIBRARYNETSDK = "Libraries\\Dahua351v8\\dhnetsdk.dll";
        const string LIBRARYCONFIGSDK = "Libraries\\Dahua351v8\\dhconfigsdk.dll";
#endif
