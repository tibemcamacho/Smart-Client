...
{
    public class AxisDownloadEncoder : IDriverDownload, IDisposable
    {
        ...
        public AxisDownloadEncoder(BookmarkGroupElementDTO bookmarkGroupElement, CameraDTO camera, string fileName)
        {
