...
namespace Elipgo.SmartClient.Drivers.Dahua351v7.NetSDKCS
{
...
#else
        const string LIBRARYNETSDK = "Libraries\\Dahua351v7\\dhnetsdk.dll";
        const string LIBRARYCONFIGSDK = "Libraries\\Dahua351v7\\dhconfigsdk.dll";
#endif
