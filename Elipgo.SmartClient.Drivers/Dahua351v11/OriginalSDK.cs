...
namespace Elipgo.SmartClient.Drivers.Dahua351v11.NetSDKCS
{
    internal static class OriginalSDK
    {
...
#else
        const string LIBRARYNETSDK = "Libraries\\Dahua351v11\\dhnetsdk.dll";
        const string LIBRARYCONFIGSDK = "Libraries\\Dahua351v11\\dhconfigsdk.dll";
#endif
        ...
        [DllImport(LIBRARYNETSDK)]
        public static extern IntPtr CLIENT_AdaptiveDownloadByTime(IntPtr lLoginID, ref NET_IN_ADAPTIVE_DOWNLOAD_BY_TIME pstInParam, ref NET_OUT_ADAPTIVE_DOWNLOAD_BY_TIME pstOutParam, uint dwWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern IntPtr CLIENT_DownloadByTime(IntPtr lLoginID, int nChannelId, int nRecordFileType, ref NET_TIME tmStart, ref NET_TIME tmEnd, string sSavedFileName, fTimeDownLoadPosCallBack cbTimeDownLoadPos, IntPtr dwUserData);
