...
namespace Elipgo.SmartClient.Drivers.Dahua351v5.NetSDKCS
{
...
#else
        const string LIBRARYNETSDK = "Libraries\\Dahua351v5\\dhnetsdk.dll";
        const string LIBRARYCONFIGSDK = "Libraries\\Dahua351v5\\dhconfigsdk.dll";
#endif
