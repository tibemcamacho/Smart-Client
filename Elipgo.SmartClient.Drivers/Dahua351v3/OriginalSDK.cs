...
namespace Elipgo.SmartClient.Drivers.Dahua351v3.NetSDKCS
{
...
#else
        const string LIBRARYNETSDK = "Libraries\\Dahua351v3\\dhnetsdk.dll";
        const string LIBRARYCONFIGSDK = "Libraries\\Dahua351v3\\dhconfigsdk.dll";
#endif
