...
namespace Elipgo.SmartClient.Drivers.Dahua351v9.NetSDKCS
{
...
#else
        const string LIBRARYNETSDK = "Libraries\\Dahua351v9\\dhnetsdk.dll";
        const string LIBRARYCONFIGSDK = "Libraries\\Dahua351v9\\dhconfigsdk.dll";
#endif
