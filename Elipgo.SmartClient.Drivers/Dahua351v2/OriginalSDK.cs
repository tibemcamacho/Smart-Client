...
namespace Elipgo.SmartClient.Drivers.Dahua351v2.NetSDKCS
{
...
#else
        const string LIBRARYNETSDK = "Libraries\\Dahua351v2\\dhnetsdk.dll";
        const string LIBRARYCONFIGSDK = "Libraries\\Dahua351v2\\dhconfigsdk.dll";
#endif
